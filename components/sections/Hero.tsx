    ...
    <section className="relative flex min-h-[88vh] flex-col justify-between overflow-hidden border-b border-[var(--line)]">
      ...
      <div className="pointer-events-none relative z-[2] mx-auto w-full max-w-[1280px] px-6 pt-24 lg:px-10 lg:pt-[148px]">
        <div className="pointer-events-auto">
          ...
          <p className="mt-7 max-w-[46ch] text-[20px] font-light leading-[1.7] text-[var(--mute)]">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-7">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 rounded-[2px] bg-[var(--nd)] px-6 py-[14px] text-[16.5px] font-semibold text-[var(--void)] transition-colors duration-200 hover:bg-[var(--nd-hi)]"
            >
              Explore solutions
            ...
            <Link
              href="/contact"
              className="group inline-flex items-center gap-2 border-b border-[var(--line2)] pb-1 text-[17px] font-medium text-[var(--bone)] transition-colors duration-200 hover:border-[var(--nd)] hover:text-[var(--nd)]"
            >
              Speak to an expert
              <ArrowRight className="h-[15px] w-[15px]" />
            </Link>
